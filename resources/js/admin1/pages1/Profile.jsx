        ...
        <div >
            ...
            <div className=" info dark:bg-slate-700 flex justify-start bg-slate-100 ">
                ...
                <div className="dark:bg-slate-500 post w-[990px] h-[20vw] flex flex-col justify-between rounded-md bg-white mt-5 ml-10 mb-5 shadow-md">
                    bio
                    <div className='m-10'>
                      Lorem ipsum dolor sit amet consectetur adipisicing elit. Dignissimos, quae. Quis numquam ratione sapiente consequatur perspiciatis ex, dolor hic iure itaque similique quidem velit sed maxime a minima omnis suscipit.
                      Lorem ipsum dolor sit amet consectetur, adipisicing elit. Ducimus quaerat id earum dicta eaque accusamus commodi incidunt recusandae consequatur, quisquam veritatis explicabo? Reprehenderit ipsam nihil repellendus praesentium, pariatur hic sed.
                      Lorem ipsum dolor sit, amet consectetur adipisicing elit. Nihil unde laborum facere molestias, repudiandae ad aperiam hic placeat quia consequuntur impedit dignissimos voluptas laudantium, earum accusantium, eveniet autem iste odit!
                      Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quae odio esse possimus neque velit earum nihil voluptatum, cupiditate dicta soluta mollitia dolorum consequatur ipsum voluptates dolore similique id quod autem.
                    </div>
                </div>
            </div>
