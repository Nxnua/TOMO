                    ...
                    <li>
                        <a href="">
                            <img
                                ...
                                width={30}
                                height={30}
                                className="mt-[5px] hover:opacity-70"
                            />
                        </a>
                    </li>
                    <li>
                        <button className="bg-white border-4 border-orange text-orange px-6 py-1 rounded-2xl hover:bg-warning hover:text-white">
                            Sign In
                        </button>
                        <button className="ml-2 border-4 border-orange bg-orange text-white px-6 py-1 rounded-2xl hover:bg-orange">
                            Sign Up
                        </button>
                    </li>
                    <li>
