export default function Footer(){
    const menu = [{ id: 1, title :"Trips", link : ""}, { id: 2,title :"Guides", link : ""},{ id: 3,title :"Agencies", link : ""},{ id: 4,title :"Reviews", link : ""},];
    const tripPlanner = [{id: 1, title :"Plan a trip", link : ""}, { id: 2, title :"Travel Budget", link : ""},{ id:3, title :"Flights", link : ""}];
    return(
