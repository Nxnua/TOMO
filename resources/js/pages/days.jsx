...
export const Days = () => {
    ...
    return (
        <>
            <div>
                ...
                <form className="mx-auto w-[900px] mt-10 ">
                    ...
                    <input
                        type="tel"
                        id="phone"
                        className="w-full p-4  bg-white  border mt-10"
            ...
            <Link to="/plantrip/prefer">
                <button className="mt-10 mb-3 rounded-full bg-yellow-400 py-2 px-3.5 text-sm capitalize text-white">
                    next
                </button>
            </Link>
        </>
